...
class DbBookAdapter(
    ...
    override fun searchBooks(hint: String): List<BookSearchResponseItem> = dsl
        ...
        .fetch { BookSearchResponseItem(BookField(
    ...
    private fun prepareAuthorRemovals(isbn: Isbn, authors: Collection<AuthorId>): DeleteConditionStep<BookAuthorRecord> = dsl.deleteFrom(BOOK_AUTHOR)
