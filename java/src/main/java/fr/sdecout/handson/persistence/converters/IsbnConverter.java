...
/**
 * <h1>TODO: STEP 7</h1>
 * <p>You have probably introduced a lot of calls to `Isbn.compressedValue` and `Isbn.formattedValue` in your queries, with a high risk of inconsistency.</p>
 *
...
public final class IsbnConverter extends AbstractConverter<String, Isbn> {
    ...
    @Override public Isbn from(String databaseObject) {
        return new Isbn(databaseObject);
    }

    @Override public String to(Isbn userObject) {
